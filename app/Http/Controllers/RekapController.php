...
class RekapController extends Controller
{
    ...
    public function show($id)
    {
      DB::beginTransaction();
      try {
        $abs = Absen::join("karyawan", "karyawan.user", "=", "absen.id_karyawan")->leftJoin("logbook", "absen.tanggal_absen", "=", "logbook.tanggal_absen")
    ...
    public function rekapKaryawan (){
      DB::beginTransaction();
      try {
        $abs = Absen::leftJoin("karyawan", "karyawan.user", "=", "absen.id_karyawan")->leftJoin("logbook", "absen.tanggal_absen", "=", "logbook.tanggal_absen")
